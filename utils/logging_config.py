...
class HighlightLogger(logging.Logger):
    ...
    def _highlight_log(self, color, msg, *args, **kwargs):
        if isinstance(msg, str):
            highlighted_msg = f"{self._highlight_colors[color]}{msg}{self._highlight_colors['reset']}"
        else:
            highlighted_msg = msg
...
class HighlightLoggerAdapter(logging.LoggerAdapter):
    def process(self, msg, kwargs):
        ...
        if isinstance(msg, str):
            return f"{self.logger._highlight_colors[color]}{msg}{self.logger._highlight_colors['reset']}", kwargs
        return msg, kwargs
